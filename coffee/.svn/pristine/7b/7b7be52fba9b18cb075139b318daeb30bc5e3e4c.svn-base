      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">상품 등록 페이지 입니다</h1>
          </div>
            <div class="container">
            	<form name="form1" method="post" enctype="multipart/form-data">
				  <div class="form-group">
				    <label for="exampleFormControlInput1">상품명</label>
				    <input type="text" class="form-control" id="product_name" name="product_name" placeholder="상품명을 입력해주세요">
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				    <label for="inputPrice">상품 가격</label>
				     <input type="number" class="form-control" id="price" name="price" placeholder="상품가격을 입력해주세요">
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				  	...
				  	<button type="button" class="btn btn-secondary btn-lg btn-block" onclick="product_write()" >상품 등록</button>
				  </div>
				</form>
            </div>
